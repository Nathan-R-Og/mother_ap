...
;basement key
@AP_ITEMPLACE_BasementKey := *+1
OBJ_PICK_ITEM $55
@AP_LOCCHECK_BasementKey := *
...
OBJ_PLAY_SOUND $06
@AP_ITEMPLACE_Franklin_Badge := *+1
OBJ_PICK_ITEM $68
@AP_LOCCHECK_Franklin_Badge := *
...
OBJ_IS_NOT_FACING @END-OBJ_GRAVEYARD_MUSICSWAP2
OBJ_PLAY_MUSIC $06
    @END:
OBJ_STOP
...
OBJ_IS_NOT_FACING @END-OBJ_MTITOI_CABINCUTSCENE
...
OBJ_CLEAR_FLAG $7C
OBJ_IS_NOT_FACING @WHAT-OBJ_MTITOI_CABINHEALFAIL
OBJ_SET_FLAG $7C
    @WHAT:
