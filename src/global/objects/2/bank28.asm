...
.endif
OBJ_SET_FLAG 67
@AP_ITEMPLACE_Twinkle_Scientist_1 := *+1
@AP_ITEMPLACE_Twinkle_Scientist_2 := *+2
@AP_ITEMPLACE_Twinkle_Scientist_3 := *+3
@AP_ITEMPLACE_Twinkle_Scientist_4 := *+4
.ifdef VER_JP
...
OBJ_STOP
	@J_IS_NOT_SELECTED1:
@AP_LOCCHECK_Twinkle_Scientist_X := *
.ifdef VER_JP
...
@AP_ITEMPLACE_Ellay_LifeupCream := *+1
OBJ_PICK_ITEM 65
@AP_LOCCHECK_Ellay_LifeupCream := *
...
@AP_ITEMPLACE_Twinkle_Present_1 := *
.byte 23 ; item
.byte 50 ; flag
...
.addr SPRITEDEF_PRESENT
@AP_ITEMPLACE_Twinkle_Present_2 := *
.byte 16 ; item
.byte 51 ; flag